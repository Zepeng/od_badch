...
// Fri Jan 25 00:04:52 2013 by ROOT version 5.28/00b
// from TTree skbeamsum/SK-beam summary
// found on file: /home/sklb/reduction/list/skbeamsummary/sk_beam_summary.run45.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/sklb/reduction/list/skbeamsummary/sk_beam_summary.run45.root");
      if (!f) {
         f = new TFile("/home/sklb/reduction/list/skbeamsummary/sk_beam_summary.run45.root");
      }
